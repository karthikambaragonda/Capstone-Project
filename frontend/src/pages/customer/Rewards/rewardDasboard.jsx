...
export default function RewardsDashboard() {
    ...
    return (
        <div className="bg-[#f5f5f7] min-h-screen p-6 sm:p-10 font-[system-ui]">
            <div className="bg-white border border-gray-200 rounded-3xl shadow-sm max-w-lg mx-auto p-10">
                ...
                <div className="border border-gray-300 rounded-3xl p-6 text-center shadow-sm mb-10">
                    ...
                    <p className="text-4xl font-bold mt-2">{tier.currentTier.name} {tier.currentTier.icon}</p>
